...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einsteintoolkit/einsteintoolkit/arrangements/WVUThorns/Baikal/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
...
\hspace{5mm}
 ...
 \begin{tabular*}{160mm}{cll} 
~ & After:  & baikal\_enforce\_detgbar\_equals\_detghat\_trazero \\ 
...
\hspace{5mm} baikal\_enforce\_detgbar\_equals\_detghat\_trazero 
...
\hspace{5mm}
 ...
 \begin{tabular*}{160mm}{cll} 
~ & Before:  & baikal\_enforce\_detgbar\_equals\_detghat\_trazero \\ 
~ & Language:  & c \\ 
...
\hspace{5mm}{\it compute bssn hamiltonian, momentum, and conformal connection constraints, at finite-differencing order 2 } 
...
\hspace{5mm}
 ...
 \begin{tabular*}{160mm}{cll} 
~ & After:  & baikal\_adm\_to\_bssn\_order\_2 \\ 
~& ~ &baikal\_adm\_to\_bssn\_order\_4\\ 
~ & Language:  & c \\ 
~ & Reads:  & hdd00gf \\ 
~& ~ &hdd01gf\\ 
~& ~ &hdd02gf\\ 
