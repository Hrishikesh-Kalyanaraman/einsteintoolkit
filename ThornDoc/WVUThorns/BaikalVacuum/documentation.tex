...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/einsteintoolkit/einsteintoolkit/arrangements/WVUThorns/BaikalVacuum/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
...
& ~ & description &  diagnostics. \\ 
 & LAMBDA\_CONSTRAINTGF & dimensions & 3 \\ 
 & MGF & distribution & DEFAULT \\ 
 & MU0GF & group type & GF \\ 
 & MU1GF & timelevels & 3 \\ 
 & MU2GF & variable type & REAL \\ 
\hline 
\end{tabular*} 
...
\hspace{5mm}
 ...
 \begin{tabular*}{160mm}{cll} 
~ & After:  & baikalvacuum\_enforce\_detgbar\_equals\_detghat\_trazero \\ 
...
\hspace{5mm} baikalvacuum\_enforce\_detgbar\_equals\_detghat\_trazero 

\hspace{5mm}{\it project every updated bssn/fccz4 state before its next rhs } 
...
\hspace{5mm}
 ...
 \begin{tabular*}{160mm}{cll} 
~ & Before:  & baikalvacuum\_enforce\_detgbar\_equals\_detghat\_trazero \\ 
~ & Language:  & c \\ 
...
\hspace{5mm}{\it compute bssn hamiltonian, momentum, and conformal connection constraints, at finite-differencing order 4 } 
...
\hspace{5mm}{\it compute bssn hamiltonian, momentum, and conformal connection constraints, at finite-differencing order 6 } 
...
\hspace{5mm}{\it compute bssn hamiltonian, momentum, and conformal connection constraints, at finite-differencing order 8 } 
...
\hspace{5mm}{\it project bssn/fccz4 state before pseudo-evolution routines } 


\hspace{5mm}

 \begin{tabular*}{160mm}{cll} 
~ & Before:  & baikalvacuum\_bssn\_constraints \\ 
~ & Language:  & c \\ 
~ & Reads:  & hdd00gf \\ 
~& ~ &hdd01gf\\ 
~& ~ &hdd02gf\\ 
...
\hspace{5mm}{\it project freshly initialized or restored bssn/fccz4 state } 


\hspace{5mm}

 \begin{tabular*}{160mm}{cll} 
~ & After:  & baikalvacuum\_adm\_to\_bssn\_order\_4 \\ 
~& ~ &baikalvacuum\_adm\_to\_bssn\_order\_6\\ 
~& ~ &baikalvacuum\_adm\_to\_bssn\_order\_8\\ 
~ & Language:  & c \\ 
~ & Reads:  & hdd00gf \\ 
~& ~ &hdd01gf\\ 
~& ~ &hdd02gf\\ 
